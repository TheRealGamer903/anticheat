...
-- Check for modifications to the script
script.Changed:Connect(function()
	local modifiedPlayer = game.Players:GetPlayerFromCharacter(script.Parent)
	if modifiedPlayer then
		modifiedPlayer:Kick("You attempted to modify the anti-cheat script.")
	end
end)
